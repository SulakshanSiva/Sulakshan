  ...
  return (
    <div className='about' id='about'>
        ...
        <div className='aboutInfo'>
          ...
          <p>I am a Software Engineer currently completing a Bachelor of Computing at the University of Guelph.</p>
          <p>I have a diverse set of skills with vast amounts of coding experience in JavaScript, TypeScript, Java, C, and SQL.</p>
